function Psilms = generate_psilms_NUM_SHELLS(jball, jjorigin, Y, dems_Y, dels_Y, ...
    r_cut, N, r_select_ratio, ell, ell_max, L, num_shells)
...
siz_lms = num_shells*(2*ell+1); % length(find(ell_list == ell))
...
siz_ls = num_shells;%numel(ind_ls);
